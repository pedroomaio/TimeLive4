CREATE VIEW dbo.vueAccountApproverType
AS
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vueAccountApproverType';
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "AccountApprovalType"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 121
            ...
            TopColumn = 0
         End
         Begin Table = "AccountApprovalPath"
            Begin Extent = 
               Top = 6
               Left = 275
               Bottom = 121
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vueAccountApproverType';
