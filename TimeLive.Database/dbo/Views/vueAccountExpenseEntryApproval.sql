...
SELECT     dbo.AccountProject.AccountProjectId, dbo.AccountProject.LeaderEmployeeId, dbo.AccountProject.ProjectManagerEmployeeId, 
                      ...
                      dbo.AccountEmployee.FirstName + ' ' + dbo.AccountEmployee.LastName AS EmployeeName, ISNULL(dbo.AccountEmployee.EmployeeCode + ' - ', '') 
                      + dbo.AccountEmployee.FirstName + ' ' + dbo.AccountEmployee.LastName AS EmployeeNameWithCode, dbo.AccountExpenseEntry.Approved, 
                      ...
                      dbo.AccountExpense.AccountExpenseName, dbo.AccountExpense.IsBillable, dbo.AccountExpenseEntry.AccountEmployeeId AS ExpenseEntryAccountEmployeeId, 
                      dbo.AccountExpenseEntry.Description, dbo.AccountExpenseEntry.AccountId, dbo.AccountEmployee.EMailAddress, dbo.AccountExpenseEntry.Submitted, 
