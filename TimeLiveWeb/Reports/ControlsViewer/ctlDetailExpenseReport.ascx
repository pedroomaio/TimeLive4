        ...
        <table class="xFormView" style="width: 450px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal14" runat="server" Text="<%$ Resources:TimeLive.Resource, Detail Expense Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Resource, Clients:%> " /></td></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Resource, Location:%> " /></td></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:TimeLive.Resource, Submitted:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:TimeLive.Resource, Billable:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:TimeLive.Resource, Base Currency:%> " /></td>
                </td>
                <td align="left" style="width: 60%">
