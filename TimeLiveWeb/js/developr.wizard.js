...
;(function($, window, document)
{
	...
	$.fn.wizard.defaults = {
		 ...
		 * @var string
		 */
		controlPrev: '<button type="button" class="button grey-gradient mid-margin-right wizard-previous float-left" style="width:70px;">Back</button>',

		/**
		 * Next button markup - must use class 'wizard-next'
		 * @var string
		 */
		controlNext: '<button type="button" class="button blue-gradient mid-margin-right wizard-next float-right" style="width:70px;">Next</button>'
	};
