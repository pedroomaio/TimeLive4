<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlMyProjectsChartByDuration.ascx.vb" Inherits="Employee_Controls_ctlMyProjectsChartByDuration" %>
...
<style type="text/css">
    ...
    <table class="xFormView" width="99%">
                ...
                <asp:CHART ID="Chart1" runat="server" BorderColor="#1A3B69" 
                    ...
                    <legends>
                        <asp:Legend BackColor="Transparent" Font="Trebuchet MS, 8pt, style=Bold" 
                            ...
                            TitleFont="Microsoft Sans Serif, 8pt, style=Bold" IsDockedInsideChartArea="True" MaximumAutoSize="30" LegendStyle="Table">
                        </asp:Legend>
                    </legends>
                    <series>
                        <asp:Series BorderColor="64, 64, 64, 64" ChartArea="Area1" 
                            ...
                            MarkerStyle="Circle" Name="Default" XValueType="Auto"  YValueType="Auto"  XValueMember="ProjectName" 
                            YValueMembers="EstimatedDuration" IsXValueIndexed="True" 
                            BorderDashStyle="Solid" ChartType="Pie">
                        </asp:Series> <%--LegendUrl="~/Employee/MyProjectsByStatusCountChart.aspx?IsDetail=1" 
                            Url="~/Employee/MyProjectsByStatusCountChart.aspx?IsDetail=1" 
                            LabelUrl="~/Employee/MyProjectsByStatusCountChart.aspx?IsDetail=1" --%>
                    </series>
                    <chartareas>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            SelectMethod="GetvueMyProjectsByAccountEmployeeId" 
            TypeName="AccountEmployeeChartBLL" 
    DataObjectTypeName="System.Guid" DeleteMethod="DeleteAccountEmployeeChart" 
    InsertMethod="AddAccountEmployeeCharts" 
    UpdateMethod="UpdateAccountEmployeeChartsForSelectedField">
            <InsertParameters>
                ...
                <asp:Parameter Name="IsShowLegend" Type="Boolean" />
                <asp:Parameter Name="IsShowas3D" Type="Boolean" />
                <asp:Parameter Name="DoughnutRadius" Type="Int32" />
                <asp:Parameter Name="DrawingStyle" Type="String" />
                <asp:Parameter Name="LabelStyle" Type="String" />
                <asp:Parameter Name="PointWidth" Type="Double" />
                <asp:Parameter Name="RotationAngle" Type="Int32" />
                <asp:Parameter Name="PointsGap" Type="Int32" />
                <asp:Parameter Name="LabelsPlacement" Type="String" />
                <asp:Parameter Name="MinPointHeight" Type="Int32" />
                <asp:Parameter Name="StandardPalette" Type="String" />
                <asp:Parameter Name="CustomPalette" Type="String" />
                <asp:Parameter Name="IsHideSupplementalChart" Type="Boolean" />
                <asp:Parameter Name="CollectedPercentage" Type="Int32" />
                <asp:Parameter Name="SupplementalChartSize" Type="String" />
                <asp:Parameter Name="IsCollectSmallSegments" Type="Boolean" />
            </InsertParameters>
            <SelectParameters>
            ...
            <UpdateParameters>
                ...
                <asp:Parameter DbType="Guid" Name="SystemChartId" />
                <asp:Parameter Name="AccountChartName" Type="String" />
                <asp:Parameter Name="IsShowExploded" Type="Boolean" />
                <asp:Parameter Name="IsShowLegend" Type="Boolean" />
                <asp:Parameter Name="IsShowas3D" Type="Boolean" />
                <asp:Parameter Name="CollectedThreshold" Type="Int32" />
