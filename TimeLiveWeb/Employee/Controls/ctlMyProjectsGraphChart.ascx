<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlMyProjectsGraphChart.ascx.vb" Inherits="Employee_ctlMyProjectsGraphChart" %>
<%@ Register assembly="System.Web.DataVisualization, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35" namespace="System.Web.UI.DataVisualization.Charting" tagprefix="asp" %>
    ...
    <table class="xFormView" width="99%">
                ...
                <asp:CHART ID="Chart1" runat="server" BorderColor="#1A3B69" 
                    ...
                    <series>
                        <asp:Series BorderColor="64, 64, 64, 64" ChartArea="Area1" 
                            ...
                            MarkerStyle="Circle" Name="Default" XValueType="Auto"  YValueType="Auto"  XValueMember="Status" 
                            YValueMembers="StatusCount" IsXValueIndexed="True" BorderDashStyle="Solid" ChartType="Pie">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            SelectMethod="GetProjectStatusCountByAccountProject" 
