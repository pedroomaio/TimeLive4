...
Partial Class Employee_Controls_ctlAccountProjectTaskByDuration
    ...
    Dim SystemChartId As New Guid("1738c2e8-615b-4bca-a469-c04dbd30ba24")
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Dim dt As AccountEmployeeChart.vueAccountProjectTaskDataTable = ChartBLL.GetAssignedAccountProjectTasksForChart(DBUtilities.GetSessionAccountEmployeeId, DBUtilities.GetSessionAccountId)
