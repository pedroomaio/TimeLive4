...
Partial Class Employee_Controls_ctlProjectTaskByGraph
    Inherits System.Web.UI.UserControl
    Dim LabelsPlacement As String
    Dim LabelStyle As String
    Dim StandardPalette As String
    Dim CustomPalette As String
    Dim SystemChartId As New Guid("207ce995-f826-4d17-ae63-39b4e4d198bb")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim dt As AccountEmployeeChart.vueAccountProjectTaskDataTable = ChartBLL.GetAssignedAccountProjectTasksForCompletedPercentageChart(DBUtilities.GetSessionAccountEmployeeId, DBUtilities.GetSessionAccountId)
