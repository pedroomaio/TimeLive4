...
Partial Class Employee_ctlMyProjectsGraphChart
    ...
    Dim SystemChartId As New Guid("3e678947-b3a7-40b0-8825-5586e6f10563")
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Dim dt As AccountEmployeeChart.vueAccountProjectsDataTable = ChartBLL.GetProjectStatusCountByAccountProject(DBUtilities.GetSessionAccountId, DBUtilities.GetSessionAccountEmployeeId)
