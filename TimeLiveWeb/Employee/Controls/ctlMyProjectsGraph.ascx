<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlMyProjectsGraph.ascx.vb" Inherits="Employee_Controls_ctlMyProjectsGraph" %>
                ...
                <asp:CHART ID="Chart1" runat="server" BorderColor="#1A3B69" 
                    ...
                    <legends>
                        <asp:Legend BackColor="Transparent" Font="Trebuchet MS, 8pt, style=Bold" 
                            IsEquallySpacedItems="True" IsTextAutoFit="True" Name="Default" 
                            TitleFont="Microsoft Sans Serif, 8pt, style=Bold" IsDockedInsideChartArea="True">
                        </asp:Legend>
                    </legends>
                    <series>
