...
Partial Class Employee_Controls_ctlProjectTaskCount
    ...
    Dim SystemChartId As New Guid("ae9d3aab-2d9b-4fed-bdbc-f119346375a7")
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Dim dt As TimeLiveDataSet.vueAccountProjectTaskDataTable = BLL.GetAssignedOpenAccountProjectTasksByAccountEmployeeIdForChart(DBUtilities.GetSessionAccountEmployeeId, DBUtilities.GetSessionAccountId)
