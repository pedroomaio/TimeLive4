<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GridViewTest.aspx.vb" Inherits="GridViewTest" Title="Grid View Test" %>
...
<section role="main" id="main">
				...
				Account Absence Type Information
			</div>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="AccountAbsenceTypeId" DataSourceID="dsgv"  Width="90%" 
    CssClass="table responsive-table">
        <Columns>
            <asp:BoundField DataField="AbsenceDescription" HeaderText="AbsenceDescription" 
                SortExpression="AbsenceDescription" />
            <asp:BoundField DataField="ModifiedOn" HeaderText="ModifiedOn" 
                SortExpression="ModifiedOn" />
            <asp:BoundField DataField="AccountAbsenceTypeId" 
                HeaderText="AccountAbsenceTypeId" InsertVisible="False" ReadOnly="True" 
                SortExpression="AccountAbsenceTypeId" />
    ...
    <section role="main" id="main">
				...
				Account Absence Type
			</div>
    			<table class="table responsive-table" id="Table223">

				<thead>
					<tr>
						<th scope="col"><input type="checkbox" name="check-all" id="Checkbox1" value="1"></th>
						<th scope="col">Text</th>
						<th scope="col" width="15%" class="align-center hide-on-mobile">Date</th>
						<th scope="col" width="15%" class="align-center hide-on-mobile-portrait">Status</th>
						<th scope="col" width="15%" class="hide-on-tablet">Tags</th>
				...
				<tbody>
					<tr>
						<th scope="row" class="checkbox-cell"><input type="checkbox" name="checked[]" id="Checkbox2" value="1"></th>
						<td>John Doe</td>
						<td>Jul 5, 2011</td>
						<td>Enabled</td>
						<td><small class="tag">User</small> <small class="tag">Client</small> <small class="tag green-bg">Valid</small></td>
					...
					<tr>
						<th scope="row" class="checkbox-cell"><input type="checkbox" name="checked[]" id="Checkbox3" value="2"></th>
						<td>John Appleseed</td>
						<td>Jul 5, 2011</td>
						<td>Enabled</td>
						<td><small class="tag orange-bg">Non-verified</small></td>
    ...
    <asp:ObjectDataSource ID="dsgv" runat="server" 
        OldValuesParameterFormatString="original_{0}" 
        SelectMethod="GetAccountAbsenceTypesByAccountId" 
        TypeName="AccountAbsenceTypeBLL">
        <SelectParameters>
            <asp:Parameter DefaultValue="232" Name="AccountId" Type="Int32" />
        </SelectParameters>
