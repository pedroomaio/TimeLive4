...
'    ''' </summary>
'    Public ChartAreaPosition As New RectangleF(5.0F, 5.0F, 90.0F, 90.0F)
...
'    Dim chartControl As Chart1 = Nothing
'    Dim series As Series = Nothing

'    ' Internal use fields
'    Private supplementalSeries As Series = Nothing
'    Private originalChartArea As Area1 = Nothing
'    Private supplementalChartArea As Area1 = Nothing
...
'    Public Sub New(chartControl As Chart1)
...
'        Me.chartControl.PostPaint += New EventHandler(Of ChartPaintEventArgs)(Me.chart_PostPaint)
'    End Sub
...
'    Public Sub ShowSmallSegmentsAsSupplementalPie(seriesName As String)
'        ' Validate input
...
'        For Each dataPoint As DataPoint In Me.series.Points
...
'            For Each dataPoint As DataPoint In Me.supplementalSeries.Points
'                Dim dataPointCollected As DataPoint = dataPoint.Clone()
...
'            Return True
'        ElseIf colectedDataPoint IsNot Nothing Then
...
'    Private Sub chart_PostPaint(sender As Object, e As System.Web.UI.DataVisualization.Charting.ChartPaintEventArgs)
'        If TypeOf sender Is ChartArea Then
'            Dim area As ChartArea = DirectCast(sender, ChartArea)
'            If Me.supplementalChartArea IsNot Nothing AndAlso area.Name = Me.supplementalChartArea.Name Then
...
'                Using pen As New Pen(Me.ConnectionLinesColor, 1)
...
'    Private Function GetRotatedPlotAreaPoint(areaPosition As RectangleF, angle As Single) As PointF
'        Dim points As PointF() = New PointF(0) {}
'        points(0) = New PointF(areaPosition.X + areaPosition.Width / 2.0F, areaPosition.Y)
'        Using transformMatrix As New Matrix()
...
'    Private Function GetChartAreaPlottingPosition(area As ChartArea1, chartGraphics As ChartGraphics) As RectangleF
