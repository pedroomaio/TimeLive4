...
#End Region
    Private Sub xtrEmployeeListReport_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        ...
        Me.xrLabel1.Text = Resources.TimeLive.Resource.EmployeeList_ListOfAllEmployeesDefinedByAccount
        Me.xrTableCell1.Text = Resources.TimeLive.Resource.Id
        Me.xrTableCell3.Text = Resources.TimeLive.Resource.Role
        Me.xrTableCell5.Text = Resources.TimeLive.Resource.Employee_Name
        Me.xrTableCell7.Text = Resources.TimeLive.Resource.EMail_Address_
        Me.xrTableCell9.Text = Resources.TimeLive.Resource.Department
        Me.xrTableCell5.Text = Resources.TimeLive.Resource.Location
    End Sub
End Class