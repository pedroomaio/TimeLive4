...
#End Region
    Private Sub XtraReport1_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        Me.xrLabel4.Text = Resources.TimeLive.Resource.Activities
        Me.xrLabel1.Text = Resources.TimeLive.Resource.Employee_Name
        Me.xrLabel2.Text = Resources.TimeLive.Resource.Time_Entry_Date
    End Sub
End Class