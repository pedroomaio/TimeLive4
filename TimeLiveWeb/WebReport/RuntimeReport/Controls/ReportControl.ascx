<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ReportControl.ascx.vb"
    Inherits="WebReport_RuntimeReport_Controls_ReportControl" %>
...
<div style="margin: 4px;">
    <dxxr:ReportToolbar ID="ReportToolbar1" runat="server" ShowDefaultButtons="False"
        ReportViewer="<%# ReportViewer1 %>" ClientIDMode="AutoID">
        <Items>
        ...
        <Styles>
            <LabelStyle VerticalAlign="Middle" Wrap="True"></LabelStyle>
            <ComboBoxStyle VerticalAlign="Middle" Wrap="True">
            </ComboBoxStyle>
            <ComboBoxListStyle VerticalAlign="Middle" Wrap="True">
            </ComboBoxListStyle>
            <ComboBoxButtonStyle VerticalAlign="Middle" Wrap="True">
            </ComboBoxButtonStyle>
            <ComboBoxItemStyle VerticalAlign="Middle" Wrap="True">
            </ComboBoxItemStyle>
            <TextBoxStyle VerticalAlign="Middle" Wrap="True" />
            <ButtonStyle VerticalAlign="Middle" Wrap="True">
            </ButtonStyle>
            <EditorStyle VerticalAlign="Middle" Wrap="True">
            </EditorStyle>
        </Styles>
    </dxxr:ReportToolbar>
</div>
...
<div style="margin: 0 0 0 15px;">
    <asp:Button ID="btnCustomAction" runat="server" Visible="false" />
</div>
<div style="margin: 0 0 0 15px;">
    <asp:Button ID="btnPrettyPrint" runat="server" Visible="false" />
</div>
<br />
